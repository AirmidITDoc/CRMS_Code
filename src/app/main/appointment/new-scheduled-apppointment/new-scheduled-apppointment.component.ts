...
@Component({
  selector: 'app-new-scheduled-apppointment',
  templateUrl: './new-scheduled-apppointment.component.html',
  styleUrls: ['./new-scheduled-apppointment.component.scss']
})
export class NewScheduledApppointmentComponent implements OnInit {
...
DateList: any = [];
  ...
  constructor(private _fuseSidebarService: FuseSidebarService,
    ...
    public dialogRef: MatDialogRef<NewScheduledApppointmentComponent>,
