...
import { BrowsePaymentreceiptService } from './browse-paymentreceipt.service';
...
@Component({
  selector: 'app-browse-payment-receipt',
  templateUrl: './browse-payment-receipt.component.html',
  styleUrls: ['./browse-payment-receipt.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class BrowsePaymentReceiptComponent implements OnInit {
  ...
  constructor( private _fuseSidebarService: FuseSidebarService,
    public _BrowseOpdPaymentReceiptService:BrowsePaymentreceiptService,
