...
import { DcoumentUploadComponent } from './dcoument-upload.component';
...
const routes: Routes = [
    {
        path: '**',
        component: DcoumentUploadComponent
    },
];
@NgModule({
    declarations: [
      DcoumentUploadComponent,
      UploadDocumentModelComponent,
      UploadDocumentFetchComponent             
    ],
    imports: [
