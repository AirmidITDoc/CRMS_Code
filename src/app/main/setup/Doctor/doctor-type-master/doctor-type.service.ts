...
export class DoctorTypeService {
  ...
  public getDoctortypeMasterList(param) {
      return this._httpClient.post(
          "Generic/GetByProc?procName=Rtrv_DoctorTypeMasteList_by_Name",
          param
      );
  }

  public doctortTypeMasterInsert(param) {
      return this._httpClient.post("Master/DoctorTypeSave", param);
  }

  public doctorTypeMasterUpdate(param) {
      return this._httpClient.post("Master/DoctorTypeUpdate", param);
  }
